...
class DebugTwo3
{
   static void Main()
   {
	 ...
	 hours, rate.ToString("C2"));
      WriteLine("Gross pay is {0}", gross.ToString("C2"));
      WriteLine("Withholding is {0}", withholding.ToString("C2"));
      WriteLine("Net pay is {0}", net.ToString("C2")); 
   }
}
